...
if (isset($_POST['btn-simpan'])) {
    ...
    $query = "UPDATE pelanggan SET nama_pelanggan = '$nama', alamat_pelanggan = '$alamat', no_hp = '$no_hp', jenis_kelamin = '$jenis_kelamin' WHERE id_pelanggan = $id";
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="largeInput">No HP Pelanggan</label>
                                <input type="text" name="no_hp" class="form-control form-control" id="defaultInput"
                                    value="<?= $edit['no_hp']; ?>" placeholder="No HP...">
                            </div>
                            <div class="form-group">
